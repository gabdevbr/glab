...
export type ThemeId = 'geovendas-dark' | 'classic-dark' | 'light' | 'dracula';
...
export const THEMES: ThemeOption[] = [
  { id: 'geovendas-dark', label: 'Geovendas Dark', isDark: true, accent: '#06F4E4' },
...
const DEFAULT_THEME: ThemeId = 'geovendas-dark';
