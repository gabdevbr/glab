...
type File struct {
	...
	RcFileID       pgtype.Text        `json:"rc_file_id"`
}
...
type User struct {
	...
	RcLastLoginAt    pgtype.Timestamptz `json:"rc_last_login_at"`
	LocalAuthReady   bool               `json:"local_auth_ready"`
}
